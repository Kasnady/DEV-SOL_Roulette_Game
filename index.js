...
import { airDropSol, getWalletBalance, transferSOL } from './utility.js'

async function init() {
    const fromWalletPublicKey = 'bMv3X5eZzrwLbx2PTVPHhSwR2PruywmS8ksgiujDaLz';
    ...
    const paymentSignature = await transferSOL({ publicKey: walletPublicKey }, { publicKey: fromWalletPublicKey }, 1);
    ...
    const priceSignature = await transferSOL({ publicKey: fromWalletPublicKey }, { publicKey: walletPublicKey }, 1);
